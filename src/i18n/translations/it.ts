...
export const it: TranslationKeys = {
  ...
  photoToPuzzle: {
    title: 'Foto a puzzle',
    titleDesc: 'Trasforma qualsiasi immagine in un picross giocabile',
    chooseSize: 'Dimensione griglia',
    convert: 'Converti',
    processing: 'Verifica della giocabilità…',
    preview: 'Anteprima',
    previewDesc: 'Ecco come apparirà il tuo puzzle.',
    confirmAndPlay: 'Gioca',
    notUnique: 'Questo puzzle potrebbe avere più soluzioni.',
    playAnyway: 'Gioca comunque',
    tooEmpty: "La griglia è troppo vuota o troppo piena. Prova un'altra immagine.",
  },
  options: {
    title: 'Opzioni',
    language: 'Lingua',
